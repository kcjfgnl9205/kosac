...
export default function YutGamePage() {
  ...
  return (
    <main className="flex min-h-screen">
      ...
      <GameSetupModal isOpen={isModalOpen} onClose={() => router.push("/")} onStartGame={handleStartGame} />

      <GamePopup isOpen={popupOpen} onClose={handlePopupClose} type={popupType} message={popupMessage} />
      ...
      {gameStarted && (
        <div className="flex flex-1 flex-col md:flex-row h-[calc(100vh-64px)] overflow-hidden">
          <div className="w-full md:w-1/2 flex flex-col border-r border-gray-200 h-full">
            ...
            />
            <BinaryConverter binaryValue={yutResult} onSubmit={handleDecimalSubmit} isCorrect={isCorrect} />
          </div>
