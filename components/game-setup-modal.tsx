            ...
            {[2, 3, 4].map((count) => (
              <button
                ...
                className={`px-4 py-2 rounded ${
                  playerCount === count ? "bg-blue-500 text-white" : "bg-gray-200"
                }`}
            ...
            <div key={player.id} className="flex items-center space-x-2">
              ...
              {player.id === 1 ? (
                <Image
                  width="28"
                  height="28"
                  src="/images/animals/item1-fill.svg"
                  alt="테스트 이미지"
                />
              ) : (
              ...
              {player.id === 2 ? (
                <Image
                  width="28"
                  height="28"
                  src="/images/animals/item2-fill.svg"
                  alt="테스트 이미지"
                />
              ) : (
              ...
              <Image width="28" height="28" src="/images/animals/item3.svg" alt="테스트 이미지" />
              <Image width="28" height="28" src="/images/animals/item4.svg" alt="테스트 이미지" />
              <Image width="28" height="28" src="/images/animals/item5.svg" alt="테스트 이미지" />
              <Image width="28" height="28" src="/images/animals/item6.svg" alt="테스트 이미지" />
            </div>
          ))}
        </div>
