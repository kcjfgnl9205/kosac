...
export default function YutThrowArea({ onYutThrow, yutResult, currentPlayer, throwCount }: YutThrowAreaProps) {
    ...
    <div className="p-4 flex flex-col">
      <div className="mb-2 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <div className={`w-4 h-4 rounded-full ${currentPlayer?.color || "bg-gray-400"} mr-2`}></div>
            ...
            : yutResult.length > 0
              ...
              : // 초기 상태
                Array(4)
                  .fill(0)
                  .map((_, index) => (
                    <div key={`init-${index}`} className="w-8 h-28 sm:w-10 sm:h-32 rounded-full bg-gray-200"></div>
                  ))}
        </div>
